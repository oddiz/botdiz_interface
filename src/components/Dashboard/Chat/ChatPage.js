...
function ChannelsBar(props) {
    const guildTextChannels = props.guildTextChannels
    return (
        <ChannelsBarWrapper>
            <TextChannel channelName="oyuncumasası" />
        </ChannelsBarWrapper>
    )
}
...
export default class Chat extends React.Component{
    constructor(props) {
        ...
        this.onKeyDownFunc = props.onKeyDownFunc
    ...
    render() {
        ...
        return (
            <ChatWrapper onKeyDown={this.onKeyDownFunc}>
                
                
                <ChannelsBar guildTextChannels={this.guildTextChannels} />
                <ChatContent />
            </ChatWrapper>
        )
    }
