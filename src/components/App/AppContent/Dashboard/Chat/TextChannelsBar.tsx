...
import { activeTextChannelState, ChatPageErrorMessageState, guildTextChannelsState } from './Atoms';
...
const TextChannelComponent = (props: TextChannelProps) => {
    ...
    const [activeChannel, setActiveChannel] = useRecoilState(activeTextChannelState)
...
type getTextChannelsResult = getTextChannelsSuccess | getTextChannelsFailed | unauthorizedResponse
...
const ChannelsBar = () => {
    ...
    const [textChannels, setTextChannels] = useRecoilState(guildTextChannelsState)
