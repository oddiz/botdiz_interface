...
class GuildsContent extends React.Component {
	...
	async componentDidMount() {
		if (
			...
			(this.accountInfo.is_admin && this.state.activeGuild?.id)
		) {
			...
			return (
				<GuildsContentWrapper>
					<Header>
						...
						<GuildTitle>{this.state.activeGuild.name}</GuildTitle>
					</Header>
					<AddGuildButtonWrapper>
						...
						>
							<span style={{ fontWeight: 600 }}>Add Botdiz To Your Guild</span>
						</Button>
					</AddGuildButtonWrapper>
				</GuildsContentWrapper>
			);
		...
		if (
			...
			return (
				<GuildsContentWrapper>
					...
					<SettingsWrapper>
						<SettingTitle>You have access to music player! 👍</SettingTitle>
					</SettingsWrapper>
				</GuildsContentWrapper>
			);
		}
		...
		if (
			...
			return (
				<GuildsContentWrapper>
					...
					<SettingsWrapper>
						<SettingTitle>You don't have access to this guild's Music Player</SettingTitle>

						<SettingTitle style={{ marginTop: "20px" }}>Ask an administrator for access</SettingTitle>
					</SettingsWrapper>
				</GuildsContentWrapper>
			);
		}
					...
					<SettingsWrapper>
						...
						<Setting id="subscriptions">
							<SettingHeader>
								...
								<SettingDescription>Add various subscriptions to text channels</SettingDescription>
							</SettingHeader>
