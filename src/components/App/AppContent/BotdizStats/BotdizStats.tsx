...
const BotdizStats = () => {
    ...
    useEffect(() => {
        const getBotdizStats = async () => {
            try {
                const statsReply = await fetch(
                    config.botdiz_server + '/botdizstats',
                    {
                        method: 'GET',
                        credentials: 'include',
                    },
    ...
    return (
        <BotdizStatsWrapper>
            <StatsWrapper>
                <Stat color="pink-purple">
                    <StatTitle>Total Guilds:</StatTitle>
                    <StatValue>{totalGuilds}</StatValue>
                </Stat>
                <Stat color={'purple-cyan'}>
                    <StatTitle>Total Playing:</StatTitle>
                    <StatValue>{totalPlaying}</StatValue>
                </Stat>
            </StatsWrapper>
        </BotdizStatsWrapper>
    );
